...
COUNTRIES = [
    # מזרח תיכון & אסיה
    "ישראל", "המנדט הבריטי", "האימפריה העות'מאנית", "פרס / איראן", "מצרים", "סוריה", "לבנון", "ירדן", "עיראק", "ערב הסעודית", "תורכיה", "אפגניסטן", "הודו", "סין", "יפן", "קוריאה",
    # אירופה
    "בריטניה", "צרפת", "גרמניה", "האימפריה הגרמנית", "רייך השלישי", "פרוסיה", "אוסטריה", "האימפריה האוסטרו-הונגרית", "איטליה", "האימפריה הרומית", "ספרד", "פורטוגל", "הולנד", "בלגיה", "שווייץ", "שוודיה", "דנמרק", "נורווגיה", "פולין", "צ'כוסלובקיה", "יוגוסלביה", "בולגריה", "רומניה", "יוון", "פינלנד",
    # רוסיה & ברית המועצות
    "רוסיה", "ברית המועצות", "האימפריה הרוסית",
    # אמריקה
    "ארה\"ב", "קנדה", "מקסיקו", "ברזיל", "ארגנטינה", "צ'ילה", "פרו",
    # אפריקה
    "דרום אפריקה", "מרוקו", "תוניסיה", "אלג'יריה", "לוב",
    # אחר
    "אחר"
]
...
עבור שדה country, בחר את המדינה המתאימה ביותר מהרשימה הבאה בלבד:
ישראל, המנדט הבריטי, האימפריה העות'מאנית, פרס / איראן, מצרים, סוריה, לבנון, ירדן, עיראק, ערב הסעודית, תורכיה, אפגניסטן, הודו, סין, יפן, קוריאה, בריטניה, צרפת, גרמניה, האימפריה הגרמנית, רייך השלישי, פרוסיה, אוסטריה, האימפריה האוסטרו-הונגרית, איטליה, האימפריה הרומית, ספרד, פורטוגל, הולנד, בלגיה, שווייץ, שוודיה, דנמרק, נורווגיה, פולין, צ'כוסלובקיה, יוגוסלביה, בולגריה, רומניה, יוון, פינלנד, רוסיה, ברית המועצות, האימפריה הרוסית, ארה"ב, קנדה, מקסיקו, ברזיל, ארגנטינה, צ'ילה, פרו, דרום אפריקה, מרוקו, תוניסיה, אלג'יריה, לוב, אחר
החזר JSON בפורמט:
{"name":"שם המטבע בעברית","country":"מדינה מהרשימה","year":"שנה","material":"אחד מ: כסף / זהב / נחושת / ניקל / ברונזה / אלומיניום / מתכת מעורבת","price":"מחיר משוער בשקלים"}"""
            },
            {
                "type": "image_url",
